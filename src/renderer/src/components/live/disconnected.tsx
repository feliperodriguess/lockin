	...
	return (
		<section className="flex h-full flex-col items-center justify-center gap-[22px] text-center">
			<div className="relative grid place-items-center size-[92px]">
				<span className="ccp-halo absolute inset-0 rounded-full border border-(--stroke-default)" />
				<span className="ccp-halo ccp-halo-2 absolute inset-0 rounded-full border border-(--stroke-default)" />
				<div className="ccp-breathe grid place-items-center size-[60px] rounded-full border border-(--stroke-default) bg-ink-850 text-paper-300">
